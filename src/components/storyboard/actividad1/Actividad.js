...
class Actividad extends React.Component {
  ...
  render() {
    const { dialoguesFriends, action, currentAction, currentFriend, finished } =
      this.state;
    ...
    return (
      <div style={{ paddingTop: "10vh" }}>
        ...
        <img
          src={dialoguesFriends[currentFriend].character}
          id="imgMono"
          alt=""
        ></img>
        <div style={{ position: "relative" }} id="divOptions">
          <div
            id="option-activity1"
            onClick={() =>
              this.handleAction(
